...
<tileset version="1.9" tiledversion="1.9.0" name="greenroom" tilewidth="40" tileheight="40" tilecount="126" columns="7">
 <editorsettings>
  <export target="greenroom.lua" format="lua"/>
 </editorsettings>
 <image source="../../../assets/sprites/tilesets/greenroom.png" width="280" height="720"/>
 <tile id="25">
  <animation>
