...
<tileset version="1.10" tiledversion="1.10.2" name="dw_alley_animated_ddelta_dream" tilewidth="40" tileheight="40" tilecount="33" columns="3">
 <editorsettings>
  <export target="dw_alley_animated_ddelta_dream.lua" format="lua"/>
 </editorsettings>
 <image source="../../../assets/sprites/tilesets/dw_alley_animated_ddelta_dream.png" width="120" height="440"/>
 <tile id="3">
  <animation>
