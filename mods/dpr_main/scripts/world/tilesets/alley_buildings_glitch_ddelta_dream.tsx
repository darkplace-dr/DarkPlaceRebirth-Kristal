...
<tileset version="1.10" tiledversion="1.10.2" name="alley_buildings_glitch_ddelta_dream" tilewidth="40" tileheight="40" spacing="4" margin="2" tilecount="72" columns="8">
 <editorsettings>
  <export target="alley_buildings_glitch_ddelta_dream.lua" format="lua"/>
 </editorsettings>
 <image source="../../../assets/sprites/tilesets/alley_buildings_glitch_ddelta_dream.png" width="352" height="396"/>
 <tile id="8">
  <animation>
