...
function WicabelTuning:init(enemy, battler, isdouble)
    ...
    self.bar = Sprite("ui/battle/tuning/undertale_combat_thing2", 116, 188)
...
function WicabelTuning:draw()
    Draw.draw(Assets.getTexture("ui/battle/tuning/undertale_combat_thing1"), 320, 220, 0, self.xscale, 0.5, 273, 57)
