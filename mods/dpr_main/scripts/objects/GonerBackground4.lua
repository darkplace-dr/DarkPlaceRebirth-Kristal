---@class GonerBackground4 : Object
---@overload fun(...) : GonerBackground4
local GonerBackground4, super = Class(Object)

function GonerBackground4:init(x, y)
...
function GonerBackground4:update()
