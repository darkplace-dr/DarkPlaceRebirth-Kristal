local BlendMenuOld, super = Class(Object)

function BlendMenuOld:init()
...
function BlendMenuOld:draw()
	...
	love.graphics.print(Game:getFlag("darkess_beans", 0) .. "/" .. self.blends[self.selected][4], self.width - self.font_small:getWidth(Game:getFlag("darkess_beans", 0)) - self.font_small:getWidth(self.blends[self.selected][4]), 10)
	love.graphics.print("Fountain Beans", self.width/2 - 4, 30)
	love.graphics.print(Game:getFlag("fountain_beans", 0) .. "/" .. self.blends[self.selected][5], self.width - self.font_small:getWidth(Game:getFlag("fountain_beans", 0)) - self.font_small:getWidth(self.blends[self.selected][5]), 30)
	love.graphics.print("Spam Beans", self.width/2 - 4, 50)
	love.graphics.print(Game:getFlag("spam_beans", 0) .. "/" .. self.blends[self.selected][6], self.width - self.font_small:getWidth(Game:getFlag("spam_beans", 0)) - self.font_small:getWidth(self.blends[self.selected][6]), 50)
	love.graphics.print("Binaribeans", self.width/2 - 4, 70)
	love.graphics.print(Game:getFlag("binaribeans", 0) .. "/" .. self.blends[self.selected][7], self.width - self.font_small:getWidth(Game:getFlag("binaribeans", 0)) - self.font_small:getWidth(self.blends[self.selected][7]), 70)
...
function BlendMenuOld:close()
    Game.world.menu = nil
    self:remove()
end

function BlendMenuOld:onKeyPressed(key)
