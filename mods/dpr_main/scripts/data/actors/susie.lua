...
function actor:init(style)
    ...
    self.animations_jack = {
        ...
        ["battle/idle_serious"] = {"battle_jack/idle", 1/15, false},

        ["battle/blink"]         = {"battle_jack/blink", 3/30, true, next="battle/idle", duration=12/30},
        ["battle/attack"]       = {"battle_jack/attack", 1/15, false, next="battle/attack_finish", duration=6/15},
        ["battle/attack_serious"] = {"battle_jack/attack", 1/15, false, next="battle/attack_finish", duration=6/15},
        ["battle/attack_finish"] = {"battle_jack/attack", 1/15, false},
        ["battle/act"]          = {"battle_jack/act", 1/15, false, next="battle/act_finish", duration=7/15},
        ...
        ["battle/spare"]        = {"battle_jack/spell", 1/15, true, next="battle/spare_finish", duration=8/15},
        ["battle/spare_finish"] = {"battle_jack/spell", 1/15, false},

        ["battle/attack_ready"] = {"battle_jack/attack", 1/15, false},
        ["battle/attack_ready_serious"] = {"battle_jack/attack", 1/15, false},
        ...
        ["battle/rude_buster"]  = {"battle_jack/spell", 1/15, false, next="battle/rude_buster_finish", duration=15/15},
        ["battle/rude_buster_finish"] = {"battle_jack/spell", 1/15, true},
    }
