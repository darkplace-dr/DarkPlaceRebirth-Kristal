return {
    ...
    actcool = function(cutscene, battler, enemy)
		...
		for _,battler in ipairs(Game.battle.party) do
			...
			battler:setCustomSprite("party/" .. battler.chara.id:lower() .. "/dark/battle/zoosuit_cup", offset[1] or 0, offset[2] or 0)
		end
        ...
        cutscene:text("* Everyone chat around the watercooler.")
        enemy:addMercy(25)
