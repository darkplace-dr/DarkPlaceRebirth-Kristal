...
function Basic:onStart()
    ...
    self.timer:script(function(wait)
        self:spawnBullet("arrow_final", 660, 170, math.rad(180), 10)
        self:spawnBullet("arrow_final", 660, -170, math.rad(135), 14)
        self:spawnBullet("arrow_final", 660, 510, math.rad(225), 14)
        wait(0.6)
        self:spawnBullet("arrow_final", 320, 510, math.rad(270), 10)
        self:spawnBullet("arrow_final", -20, 510, math.rad(315), 14)
        self:spawnBullet("arrow_final", 660, 510, math.rad(225), 14)
        wait(0.5)
        self:spawnBullet("arrow_final", -20, -170, math.rad(45), 14)
        self:spawnBullet("arrow_final", -20, 170, math.rad(0), 10)
        self:spawnBullet("arrow_final", -20, 510, math.rad(315), 14)
        wait(0.4)
        self:spawnBullet("arrow_final", 320, -170, math.rad(90), 10)
        self:spawnBullet("arrow_final", 660, -170, math.rad(135), 14)
        self:spawnBullet("arrow_final", -20, -170, math.rad(45), 14)
        wait(0.6)
        self:spawnBullet("arrow_final", 660, 170, math.rad(180), 10)
