    ...
    -- Get all enemies that selected this wave as their attack
        ...
        for _, attacker in ipairs(attackers) do
            ...
            if random == 1 then
                ...
                self:spawnBullet("arrow_delay", x, y, math.rad(180), -4, 120,4)
                self:spawnBullet("arrow_delay", x, y, math.rad(180), -4, 220,2.5)
            end
            if random == 2 then
                self:spawnBullet("arrow_delay", x, y, math.rad(180), -4, 170,1)
                self:spawnBullet("arrow_delay", x, y, math.rad(180), -4, 120,2.5)
                self:spawnBullet("arrow_delay", x, y, math.rad(180), -4, 220,4)
            end
            if random == 3 then
                self:spawnBullet("arrow_delay", x, y, math.rad(180), -4, 170,4)
