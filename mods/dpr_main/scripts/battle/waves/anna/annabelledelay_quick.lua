    ...
    -- Get all enemies that selected this wave as their attack
        ...
        for _, attacker in ipairs(attackers) do
            ...
            if random == 1 then
                ...
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 120,4)
            ...
            if random == 2 then
                ...
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 220,4)
            end
            if random == 3 then
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 170,4)
