...
function Basic:onStart()
    ...
    -- Get all enemies that selected this wave as their attack
        ...
        for _, attacker in ipairs(attackers) do
            ...
            self:spawnBullet("arrow_chase", x, y, angle, 4)
            self:spawnBullet("arrow_chase", x, y, angle, 3)
            self:spawnBullet("arrow_chase", x, y, angle, 2)
            self:spawnBullet("arrow_chase", x, y, angle, 1)
        end
