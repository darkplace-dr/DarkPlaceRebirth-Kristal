...
function Basic:onStart()
    ...
    self:spawnBullet("annabelle/annaspider", 270, 220, math.rad(90), 10)
    self:spawnBullet("annabelle/annaspider", 320, 20, math.rad(90), 10)
    self:spawnBullet("annabelle/annaspider", 370, 420, math.rad(90), 10)
