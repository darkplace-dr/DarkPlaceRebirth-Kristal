...
function Basic:onStart()
    ...
    -- Get all enemies that selected this wave as their attack
        ...
        for _, attacker in ipairs(attackers) do
            ...
            if random == 1 then
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 170,0.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 120,1.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 220,2.5)
            end
            if random == 2 then
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 170,0.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 120,2.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 220,1.5)
            end
            if random == 3 then
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 170,1.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 120,0.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 220,2.5)
            end
            if random == 4 then
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 170,2.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 120,0.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 220,1.5)
            end
            if random == 5 then
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 170,2.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 120,1.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 220,0.5)
            end
            if random == 6 then
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 170,1.5)
                self:spawnBullet("annabelle/arrow_delay", x, y, math.rad(180), -4, 120,2.5)
