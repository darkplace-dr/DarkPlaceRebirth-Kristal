local JackolanternMerciful, super = Class(Bullet)

function JackolanternMerciful:init(x, y, ptype)
...
function JackolanternMerciful:getDamage()
...
function JackolanternMerciful:setText(text, shake)
	if shake then
...
function JackolanternMerciful:onAdd(parent)
...
function JackolanternMerciful:update()
    super.update(self)
...
function JackolanternMerciful:onDamage(soul)
...
function JackolanternMerciful:onCollide(soul)
