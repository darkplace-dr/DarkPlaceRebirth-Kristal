local character, super = Class(PartyMember, "jerdly")
...
function character:init()
	...
	-- highlight color A
    self.highlight_color = ColorUtils.hexToRGB("#30D987FF")
		-- highlight color B
    self.highlight_color_alt = ColorUtils.hexToRGB("#30A3A6FF")
    ...
    -- Name sprite
    self.name_sprite = "party/berdly/name_j"
