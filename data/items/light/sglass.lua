local item, super = Class(Item, "light/sglass")
...
function item:init()
    ...
    self.description = "A shard of stained glass."
...
function item:onWorldUse()
    if not self:getFlag("used_lw_no_party") and #Game.party == 1 and #Game.temp_followers == 0 then
        ...
        Game.world:showText({
            "* You looked through the stained glass.",
...
function item:convertToDark(inventory)
    local shadow_crystal = inventory:addItem("lightshard")
