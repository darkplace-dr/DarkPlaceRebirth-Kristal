local item, super = Class(Item, "dino_blend")

function item:init()
    super.init(self)

    -- Display name
    self.name = "...Dino Blend?"
    ...
    self.shop = nil
    -- Menu description
    self.description = "A blend that does... something."
    ...
    self.reactions = {
        susie = "Hell yeah! Plastic dinosaurs!",
        berdly = "This isn't what gamer blood tastes like...",
	    jamm = "...What's IN this?",
        calypso = "Is that a boat??",
        noel = "... Nothing happened...",
        ceroba = "What an... interesting drink.",
        len = "It has dinosaurs floating around in it.",
        dess = "Uhhh can I have some drink with my plastic"
    }
end

function item:onWorldUse(target)
	if target.id ~= "noel" then
		target:increaseStat("health", 1)
	end
